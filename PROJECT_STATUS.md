...
| 19 | System Design | 🚧 **IN PROGRESS (v4, started 2026-07-30)** — **17 of 36 done**, all pushed & live. **§1 Fundamentals COMPLETE (11/11)**: index 44KB, estimation 30, cap-theorem 41, consistent-hashing 42, caching 50, replication 52, bloom-merkle 54, pubsub-queues 60, rest-serverless 57, microservices 55, heartbeat-gossip 49. **§2 Deep Dives COMPLETE (6/6)**: concurrency-control 51, auth-deep-dive 58, security-deep-dive 52, realtime-apps 51, concurrent-programming 49, observability 49. **NEXT: §3 Case Studies ×12** (all still 5–6KB), then §4 Senior/Staff ×7. Uses the **tradeoff-driven SD format**; case studies use the **case-study format** (both below). |
