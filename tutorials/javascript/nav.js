// JavaScript track curriculum — single source of truth for every page's sidebar.
renderSidebar([
  { title: "1. Language Core", items: [
    ["Variables, Types & Declarations", "index.html"],
    ["The Type System & Coercion", "types-coercion.html"],
    ["Operators, Equality & Truthiness", "operators-equality.html"],
    ["Numbers, BigInt & Precision", "numbers-math.html"],
  ...
  { title: "2. Objects & Data", items: [
    ...
    ["Arrays & Array Methods", "arrays.html"],
  ...
  { title: "3. Asynchronous JavaScript", items: [
    ...
    ["Promise Combinators & Concurrency", "promise-patterns.html"],
    ["Iterators & Generators", "generators-iterators.html"]] },
  { title: "4. Browser & the Web Platform", items: [
    ["The DOM", "dom.html"],
